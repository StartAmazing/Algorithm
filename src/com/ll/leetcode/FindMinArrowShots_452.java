...
public class FindMinArrowShots_452 {
    ...
    public int findMinArrowShots(int[][] points) {
        ...
        Arrays.sort(points, Comparator.comparingInt((int[] p) -> p[0]));        // 根据start排序
        int res = 1;
    ...
    public static void main(String[] args) {
        FindMinArrowShots_452 dto = new FindMinArrowShots_452();
        int[][] data = new int[][]{{10,16},{2,8},{1,6},{7,12}};
        int res = dto.findMinArrowShots(data);
